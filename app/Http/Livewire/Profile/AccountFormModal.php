...
class AccountFormModal extends Component
{
    ...
    // listen for the account-specific open event only
    protected $listeners = ['openAccountModal' => 'openAccountModal'];

    protected $rules = [];

    public function openAccountModal($params = [])
    {
    ...
    public function render()
    {
        ...
        return view('livewire.profile.account.modals.form');
    }
}
