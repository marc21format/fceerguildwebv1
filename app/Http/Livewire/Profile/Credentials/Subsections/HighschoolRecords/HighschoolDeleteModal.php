...
class HighschoolDeleteModal extends Component
{
    use Toastable;
    ...
    protected $listeners = ['openHighschoolDelete' => 'deleteHighschool', 'confirmHighschoolDelete' => 'confirm'];
    ...
    public function deleteHighschool($payload): void
    {
    ...
    {
        return view('livewire.profile.credentials.subsections.highschool_records.delete-modal');
    }
}
