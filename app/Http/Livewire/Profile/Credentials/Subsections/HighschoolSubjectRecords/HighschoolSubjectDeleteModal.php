...
class HighschoolSubjectDeleteModal extends Component
{
    use Toastable;
    ...
    protected $listeners = ['openHighschoolSubjectDelete' => 'deleteSubjects', 'confirmHighschoolSubjectDelete' => 'confirm'];
    ...
    public function deleteSubjects($payload): void
    {
    ...
    public function confirm(): void
    {
        ...
        try {
            ...
            // Notify list components explicitly so they can clear selection state
            $this->emit('highschoolSubjectDeleted');
    ...
    {
        return view('livewire.profile.credentials.subsections.highschool_subject_records.delete-modal');
    }
}
