...
class ClassroomResponsibilitiesForceDeleteModal extends Component
{
    use Toastable;
    ...
    protected $listeners = [
        'openClassroomResponsibilitiesForceDeleteModal' => 'open',
        'confirmClassroomResponsibilitiesForceDelete' => 'openFromConfirm',
    ];
    ...
    {
        return view('livewire.profile.fceer.subsections.classroom_responsibilities.force-delete-modal');
    }
}
