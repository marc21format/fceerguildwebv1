...
class PersonalFormModal extends Component
{
    ...
    // listen for the personal-specific open event only
    protected $listeners = ['openPersonalModal' => 'openPersonalModal'];

    protected $rules = [];

    public function openPersonalModal($params = [])
    {
    ...
    public function render()
    {
        ...
        return view('livewire.profile.personal.modals.form');
    }
}
