<div>
    @if($open ?? false)
        <div class="fixed inset-0 bg-black/20 backdrop-blur-sm flex items-center justify-center z-50">
            <flux:modal name="subject-teacher-details-modal" flyout class="w-11/12 max-w-2xl" wire:model="open" @close="$set('open', false)">
                <div class="space-y-6">
                    <div>
                        ...
                        @foreach($fields as $f)
                            ...
                            @if(! $isEmpty)
                                <div class="profile-details-field-row">
                                    ...
                                    <div class="profile-details-value">{{ $val }}</div>
                                </div>
                            @endif
                        @endforeach
