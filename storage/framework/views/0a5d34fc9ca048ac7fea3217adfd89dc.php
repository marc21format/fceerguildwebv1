...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::icon.index','data' => ['name' => 'users','class' => 'w-5 h-5 text-gray-700 dark:text-gray-300']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => 'users','class' => 'w-5 h-5 text-gray-700 dark:text-gray-300']); ?>
...
<?php endif; ?>
    ...
    <?php if (! $__env->hasRenderedOnce('b01fd699-814f-4543-9470-0143fd4a4a6b')): $__env->markAsRenderedOnce('b01fd699-814f-4543-9470-0143fd4a4a6b'); ?>
                ...
                <tbody class="divide-y">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tr
                            ...
                            <td class="px-4 py-2 text-sm text-gray-500 dark:text-gray-400"><?php echo e(optional($item->committee)->name ?? ($item->committee_id ? $item->committee_id : '—')); ?></td>
                            <td class="px-4 py-2 text-sm text-gray-500 dark:text-gray-400"><?php echo e(optional($item->committeePosition)->name ?? ($item->committee_position_id ? $item->committee_position_id : '—')); ?></td>
...
<?php endif; ?>
                    ...
                    <div class="space-y-1">
                        <div class="text-md text-gray-900 dark:text-white"><?php echo e(optional($item->committee)->name ?? '—'); ?></div>
                        <div class="text-sm text-gray-500 dark:text-gray-400"><?php echo e(optional($item->committeePosition)->name ?? '—'); ?></div>
                    </div>
...
[$__name, $__params] = $__split('profile.fceer.subsections.committee-memberships.committee-memberships-form-modal', ['instanceKey' => 'App\\Models\\CommitteeMembership']);

$key = 'committee-memberships-form-'.$user->id;

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-80802265-0', 'committee-memberships-form-'.$user->id);
...
[$__name, $__params] = $__split('profile.fceer.subsections.committee-memberships.committee-memberships-confirm-modal', []);

$key = 'committee-memberships-confirm-'.$user->id;

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-80802265-1', 'committee-memberships-confirm-'.$user->id);
...
[$__name, $__params] = $__split('profile.fceer.subsections.committee-memberships.committee-memberships-archive', []);

$key = 'committee-memberships-archive-'.$user->id;

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-80802265-2', 'committee-memberships-archive-'.$user->id);
...
[$__name, $__params] = $__split('profile.fceer.subsections.committee-memberships.committee-memberships-delete-modal', []);

$key = 'committee-memberships-delete-'.$user->id;

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-80802265-3', 'committee-memberships-delete-'.$user->id);
...
[$__name, $__params] = $__split('profile.fceer.subsections.committee-memberships.committee-memberships-details-modal', []);

$key = 'committee-memberships-details-'.$user->id;

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-80802265-4', 'committee-memberships-details-'.$user->id);
...
[$__name, $__params] = $__split('profile.fceer.subsections.committee-memberships.committee-memberships-force-delete-modal', []);

$key = 'committee-memberships-force-delete-'.$user->id;

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-80802265-5', 'committee-memberships-force-delete-'.$user->id);
...
[$__name, $__params] = $__split('profile.fceer.subsections.committee-memberships.committee-memberships-restore-modal', []);

$key = 'committee-memberships-restore-'.$user->id;

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-80802265-6', 'committee-memberships-restore-'.$user->id);
...
<?php /**PATH C:\Users\Marc Ian C. Young\laravel\fceerguildweb\resources\views/livewire/profile/fceer/subsections/committee_memberships/index.blade.php ENDPATH**/ ?>