...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::icon.index','data' => ['name' => 'school','class' => 'w-5 h-5 text-gray-700 dark:text-gray-300']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => 'school','class' => 'w-5 h-5 text-gray-700 dark:text-gray-300']); ?>
...
<?php endif; ?>
                <div class="profile-card-title">Highschool Records</div>
            </div>
...
<?php endif; ?>
    ...
    <?php if (! $__env->hasRenderedOnce('551ff970-2ae3-499a-b543-75d4a2860331')): $__env->markAsRenderedOnce('551ff970-2ae3-499a-b543-75d4a2860331'); ?>
                ...
                <thead class="bg-gray-50 dark:bg-zinc-900"
                    ...
                    <tr>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $fields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array($field['key'], ['year_started','year_ended'])): ?>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array($field['key'], ['year_started','year_ended'])): ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(! $insertedYear): ?>
                                        <td class="px-4 py-2 text-sm text-gray-700 dark:text-gray-200">
                                            <?php echo e($item->year_started ?? '—'); ?> — <?php echo e($item->year_ended ?? '—'); ?>
                                                ...
                                                <?php
                                                    ...
                                                    if ($field['key'] === 'level') {
                                                        if ($val) {
                                                            ...
                                                            $display = str_contains($valLower, 'highschool') ? ucwords($val) : ucwords($val) . ' Highschool';
                                                        } else {
                                                            $display = 'N/A';
                                                        }
                                                    } else {
...
<?php endif; ?>
                    ...
                    <div class="space-y-1">
                        <div class="text-sm font-semibold text-gray-800 dark:text-gray-100"><?php echo e(optional($item->highschool)->name ?? '—'); ?></div>
                        <?php
                            $lvl = $item->level ?? null;
                            if ($lvl) {
                                $lvlLower = strtolower($lvl);
                                $displayLevel = str_contains($lvlLower, 'highschool') ? ucwords($lvl) : ucwords($lvl) . ' Highschool';
                            } else {
                                $displayLevel = '—';
                            }
                        ?>
                        <div class="text-sm text-gray-600 dark:text-gray-300"><?php echo e($displayLevel); ?></div>
                        <div class="text-xs text-gray-500 dark:text-gray-400"><?php echo e($item->year_started ?? '—'); ?> — <?php echo e($item->year_ended ?? '—'); ?></div>
                    </div>
...
[$__name, $__params] = $__split('profile.credentials.subsections.highschool-records.highschool-records-form-modal', ['instanceKey' => 'App\\Models\\HighschoolRecord']);

$key = 'highschool-records-form-'.$user->id;

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-2403519759-0', 'highschool-records-form-'.$user->id);
...
[$__name, $__params] = $__split('profile.credentials.subsections.highschool-records.details-modal', []);

$key = 'highschool-records-details-'.$user->id;

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-2403519759-1', 'highschool-records-details-'.$user->id);
...
[$__name, $__params] = $__split('profile.credentials.subsections.highschool-records.highschool-records-archive', []);

$key = 'highschool-records-archive-'.$user->id;

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-2403519759-2', 'highschool-records-archive-'.$user->id);
...
[$__name, $__params] = $__split('profile.credentials.subsections.highschool-records.delete-modal', []);

$key = 'highschool-records-delete-'.$user->id;

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-2403519759-3', 'highschool-records-delete-'.$user->id);
...
[$__name, $__params] = $__split('profile.credentials.subsections.highschool-records.restore-modal', []);

$key = 'highschool-records-restore-'.$user->id;

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-2403519759-4', 'highschool-records-restore-'.$user->id);
...
[$__name, $__params] = $__split('profile.credentials.subsections.highschool-records.force-delete-modal', []);

$key = 'highschool-records-force-delete-'.$user->id;

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-2403519759-5', 'highschool-records-force-delete-'.$user->id);
...
<?php /**PATH C:\Users\Marc Ian C. Young\laravel\fceerguildweb\resources\views/livewire/profile/credentials/subsections/highschool_records/index.blade.php ENDPATH**/ ?>