...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::icon.index','data' => ['name' => 'graduation-cap','class' => 'w-5 h-5 text-gray-500 dark:text-gray-300']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => 'graduation-cap','class' => 'w-5 h-5 text-gray-500 dark:text-gray-300']); ?>
...
<?php endif; ?>
                <div class="profile-card-title">Educational Records</div>
            </div>
...
<?php endif; ?>
    ...
    <?php if (! $__env->hasRenderedOnce('4b8efc16-023c-4ca8-96d3-c2ddf0b79cf7')): $__env->markAsRenderedOnce('4b8efc16-023c-4ca8-96d3-c2ddf0b79cf7'); ?>
                ...
                <thead class="bg-gray-50 dark:bg-zinc-900"
                    ...
                    <tr>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $fields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array($field['key'], ['year_started','year_graduated'])): ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(! $insertedYear): ?>
                                    <th class="px-4 py-2 text-left text-sm font-medium text-gray-500 dark:text-gray-300">Year</th>
                                    <?php $insertedYear = true; ?>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php else: ?>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array($field['key'], ['year_started','year_graduated'])): ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(! $insertedYear): ?>
                                        <td class="px-4 py-2 text-sm text-gray-700 dark:text-gray-200">
                                            <?php echo e($item->year_started ?? '—'); ?> — <?php echo e($item->year_graduated ?? '—'); ?>
                                ...
                                <?php else: ?>
                                    <td class="px-4 py-2 text-sm text-gray-700 dark:text-gray-200">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($field['type'] === 'select'): ?>
                                                <?php
                                                    $val = $item->{$field['key']} ?? null;
                                                    $display = null;

                                                    if (is_object($val) || is_array($val)) {
                                                        $display = $val->name ?? (string) $val;
                                                    } elseif (is_scalar($val) && $val !== null) {
                                                        $display = $val;
                                                    }

                                                    if (empty($display)) {
                                                        if (str_ends_with($field['key'], '_id')) {
                                                            $rel = substr($field['key'], 0, -3);
                                                            $relMethod = \Illuminate\Support\Str::camel($rel);
                                                            $display = optional($item->{$relMethod})->name ?? null;
                                                        }

                                                        if (empty($display)) {
                                                            $relMethod = \Illuminate\Support\Str::camel($field['key']);
                                                            $display = optional($item->{$relMethod})->name ?? null;
                                                        }
                                                    }
...
<?php endif; ?>
                    ...
                    <div class="space-y-1">
                        <div class="text-sm font-semibold text-gray-800 dark:text-gray-100"><?php echo e(optional($item->degreeProgram)->name ?? '—'); ?></div>
                        <div class="text-sm text-gray-600 dark:text-gray-300"><?php echo e(optional($item->university)->name ?? '—'); ?></div>
                        <div class="text-xs text-gray-500 dark:text-gray-400"><?php echo e($item->year_started ?? '—'); ?> — <?php echo e($item->year_graduated ?? '—'); ?></div>
                    </div>
...
[$__name, $__params] = $__split('profile.credentials.subsections.educational-records.educational-records-form-modal', ['instanceKey' => 'App\\Models\\EducationalRecord']);

$key = 'educational-records-form-'.$user->id;

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-963674277-0', 'educational-records-form-'.$user->id);
...
[$__name, $__params] = $__split('profile.credentials.subsections.educational-records.educational-records-details-modal', []);

$key = 'educational-records-details-'.$user->id;

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-963674277-1', 'educational-records-details-'.$user->id);
...
[$__name, $__params] = $__split('profile.credentials.subsections.educational-records.delete-modal', []);

$key = 'educational-records-delete-'.$user->id;

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-963674277-2', 'educational-records-delete-'.$user->id);
...
[$__name, $__params] = $__split('profile.credentials.subsections.educational-records.restore-modal', []);

$key = 'educational-records-restore-'.$user->id;

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-963674277-3', 'educational-records-restore-'.$user->id);
...
[$__name, $__params] = $__split('profile.credentials.subsections.educational-records.force-delete-modal', []);

$key = 'educational-records-force-delete-'.$user->id;

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-963674277-4', 'educational-records-force-delete-'.$user->id);
...
[$__name, $__params] = $__split('profile.credentials.subsections.educational-records.educational-records-archive', []);

$key = 'educational-records-archive-'.$user->id;

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-963674277-5', 'educational-records-archive-'.$user->id);
...
<?php /**PATH C:\Users\Marc Ian C. Young\laravel\fceerguildweb\resources\views/livewire/profile/credentials/subsections/educational_records/index.blade.php ENDPATH**/ ?>