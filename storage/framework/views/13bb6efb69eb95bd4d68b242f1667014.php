...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::icon.index','data' => ['name' => 'book-open','class' => 'w-5 h-5 text-gray-700 dark:text-gray-300']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => 'book-open','class' => 'w-5 h-5 text-gray-700 dark:text-gray-300']); ?>
...
<?php endif; ?>
                <div class="profile-card-title">Subject Assignments</div>
            </div>
...
<?php endif; ?>
    ...
    <?php if (! $__env->hasRenderedOnce('a54c698b-ee0e-4a16-a17b-883c6fcfabb0')): $__env->markAsRenderedOnce('a54c698b-ee0e-4a16-a17b-883c6fcfabb0'); ?>
            ...
            <table class="min-w-full divide-y">
                <thead class="bg-gray-50 dark:bg-zinc-900"
                    ...
                    <tr>
                        ...
                        <th class="px-4 py-2 text-left text-sm font-medium text-gray-500 dark:text-gray-300">Proficiency</th>
                ...
                <tbody class="divide-y">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tr
                            ...
                            <td class="px-4 py-2 text-sm text-gray-500 dark:text-gray-400"><?php echo e(optional($item->volunteerSubject)->name ?? ($item->volunteer_subject_id ? $item->volunteer_subject_id : '—')); ?></td>
                            <td class="px-4 py-2 text-sm text-gray-500 dark:text-gray-400"><?php echo e($item->subject_proficiency ?? '—'); ?></td>
...
<?php endif; ?>
                    ...
                    <div class="space-y-1">
                        <div class="text-md text-gray-900 dark:text-white"><?php echo e(optional($item->volunteerSubject)->name ?? '—'); ?></div>
                        <div class="text-sm text-gray-500 dark:text-gray-400"><?php echo e($item->subject_proficiency ?? '—'); ?></div>
                    </div>
...
[$__name, $__params] = $__split('profile.fceer.subsections.subject-teachers.subject-teachers-form-modal', ['instanceKey' => 'App\\Models\\SubjectTeacher']);

$key = 'subject-teachers-form-'.$user->id;

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-2921964421-0', 'subject-teachers-form-'.$user->id);
...
[$__name, $__params] = $__split('profile.fceer.subsections.subject-teachers.subject-teachers-confirm-modal', []);

$key = 'subject-teachers-confirm-'.$user->id;

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-2921964421-1', 'subject-teachers-confirm-'.$user->id);
...
[$__name, $__params] = $__split('profile.fceer.subsections.subject-teachers.subject-teachers-archive-modal', []);

$key = 'subject-teachers-archive-'.$user->id;

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-2921964421-2', 'subject-teachers-archive-'.$user->id);
...
[$__name, $__params] = $__split('profile.fceer.subsections.subject-teachers.subject-teacher-delete-modal', []);

$key = 'subject-teacher-delete-'.$user->id;

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-2921964421-3', 'subject-teacher-delete-'.$user->id);
...
[$__name, $__params] = $__split('profile.fceer.subsections.subject-teachers.subject-teachers-details-modal', []);

$key = 'subject-teachers-details-'.$user->id;

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-2921964421-4', 'subject-teachers-details-'.$user->id);
...
[$__name, $__params] = $__split('profile.fceer.subsections.subject-teachers.subject-teacher-force-delete-modal', []);

$key = 'subject-teacher-force-delete-'.$user->id;

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-2921964421-5', 'subject-teacher-force-delete-'.$user->id);
...
[$__name, $__params] = $__split('profile.fceer.subsections.subject-teachers.subject-teacher-restore-modal', []);

$key = 'subject-teacher-restore-'.$user->id;

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-2921964421-6', 'subject-teacher-restore-'.$user->id);
...
<?php /**PATH C:\Users\Marc Ian C. Young\laravel\fceerguildweb\resources\views/livewire/profile/fceer/subsections/subject_teachers/index.blade.php ENDPATH**/ ?>