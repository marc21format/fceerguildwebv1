<div x-data='{
    ...
    get display() { return this.options[this.selected] ?? "<?php echo e($placeholder ?? 'Select'); ?>"; },
    ...
    select(id) { this.selected = id; $wire.set("state.<?php echo e($name); ?>", id); this.open = false; this.search = ""; }
    ...
    <div x-show="open" x-cloak @click.outside="open = false" class="absolute z-50 mt-1 w-full bg-white dark:bg-zinc-700 border border-gray-200 dark:border-zinc-600 rounded shadow-lg">
        <div class="px-3 py-2 border-b border-gray-100 dark:border-zinc-600">
            <div class="relative">
                <span class="absolute left-3 top-3 text-zinc-400"><?php if (isset($component)) { $__componentOriginalc7d5f44bf2a2d803ed0b55f72f1f82e2 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc7d5f44bf2a2d803ed0b55f72f1f82e2 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::icon.index','data' => ['name' => 'search','class' => 'w-4 h-4']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php /**PATH C:\Users\Marc Ian C. Young\laravel\fceerguildweb\resources\views/livewire/components/searchable-select.blade.php ENDPATH**/ ?>