...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::modal.index','data' => ['name' => 'reference-form-modal','flyout' => true,'class' => 'w-11/12 max-w-2xl','wire:model' => 'open','@close' => '$set(\'open\', false)']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => 'reference-form-modal','flyout' => true,'class' => 'w-11/12 max-w-2xl','wire:model' => 'open','@close' => '$set(\'open\', false)']); ?>
                <div class="space-y-6 text-gray-100">
                    <div>
                        <h2 class="text-2xl font-semibold text-white"><?php echo e($actionLabel); ?><?php echo e($tableLabel ? ' ' . $tableLabel : ''); ?></h2>
                        <div class="mt-3 mb-4 border-b border-gray-700"></div>
                    </div>

                    <div class="grid grid-cols-1 gap-4">
                        <?php echo $__env->make('livewire.reference.modal._form-fields', ['fields' => $fields], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    </div>
...
<?php /**PATH C:\Users\Marc Ian C. Young\laravel\fceerguildweb\resources\views/livewire/reference/modal/form-modal.blade.php ENDPATH**/ ?>