...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::modal.index','data' => ['name' => 'subject-teacher-details-modal','flyout' => true,'class' => 'w-11/12 max-w-2xl','wire:model' => 'open','@close' => '$set(\'open\', false)']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => 'subject-teacher-details-modal','flyout' => true,'class' => 'w-11/12 max-w-2xl','wire:model' => 'open','@close' => '$set(\'open\', false)']); ?>
                <div class="space-y-6">
                    <div>
                         <h2 class="profile-details-title">Subject Assignment Details</h2>
                         <div class="profile-details-divider"></div>
                    </div>

                    <div class="space-y-3">
                        <h4 class="profile-details-section-title">Assignment Details</h4>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $fields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(! $isEmpty): ?>
                                <div class="profile-details-field-row">
                                    ...
                                    <div class="profile-details-value"><?php echo e($val); ?></div>
                                </div>
...
<?php /**PATH C:\Users\Marc Ian C. Young\laravel\fceerguildweb\resources\views/livewire/profile/fceer/subsections/subject_teachers/details-modal.blade.php ENDPATH**/ ?>