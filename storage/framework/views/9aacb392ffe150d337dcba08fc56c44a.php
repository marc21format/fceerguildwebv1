<div>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($renderTrigger) && $renderTrigger): ?>
        <div class="ml-3">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::modal.trigger','data' => ['name' => 'professional-archive']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => 'professional-archive']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::modal.index','data' => ['name' => 'professional-archive','flyout' => true,'position' => 'bottom','class' => 'md:w-lg','wire:model' => 'open','@close' => '$set(\'open\', false)','role' => 'dialog','ariaModal' => 'true']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'professional-archive','flyout' => true,'position' => 'bottom','class' => 'md:w-lg','wire:model' => 'open','@close' => '$set(\'open\', false)','role' => 'dialog','aria-modal' => 'true']); ?>
                <div class="space-y-4">
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?>Manage soft-deleted professional credentials. Restore or permanently delete items. <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
                                ...
                                <div class="overflow-x-auto" x-on:mouseenter="$store.rowHover.hovered = 'archive'" x-on:mouseleave="$store.rowHover.hovered = null">
                                    ...
                                    <thead class="bg-gray-50 dark:bg-zinc-900" x-on:mouseenter="$store.rowHover.hovered = 'archive'" x-on:mouseleave="$store.rowHover.hovered = null">
                                        <tr>
                                            ...
                                            <th class="px-4 py-2 text-left text-sm font-medium text-gray-500 dark:text-gray-300">Issued On</th>
                                    ...
                                    <tbody class="divide-y">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            ...
                                            <tr class="group bg-white dark:bg-zinc-800" wire:key="archive-row-<?php echo e($rowKeyStr); ?>" @click.prevent="if ($event.target.closest('button, input, a')) return; $wire.toggleRow('<?php echo e($rowKeyStr); ?>')" x-on:mouseenter="$store.rowHover.hovered = '<?php echo e($rowKeyStr); ?>'" x-on:mouseleave="$store.rowHover.hovered = null">
                                                ...
                                                <td class="px-4 py-2 text-sm text-gray-700 dark:text-gray-200"><?php echo e(optional($item->fieldOfWork)->name ?? '—'); ?></td>
                                                <td class="px-4 py-2 text-sm text-gray-700 dark:text-gray-200"><?php echo e(optional($item->prefix)->name ? (optional($item->prefix)->name . (optional($item->prefix)->abbreviation ? ' (' . optional($item->prefix)->abbreviation . ')' : '')) : (optional($item->suffix)->title ? (optional($item->suffix)->title . (optional($item->suffix)->abbreviation ? ' (' . optional($item->suffix)->abbreviation . ')' : '')) : '—')); ?></td>
                                                <td class="px-4 py-2 text-sm text-gray-700 dark:text-gray-200"><?php echo e($item->issued_on ?? ''); ?></td>
...
<?php endif; ?>
                                        ...
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                            <tr>
                                                <td colspan="8" class="px-4 py-6 text-sm text-muted">No archived items found.</td>
                                            </tr>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </tbody>
                                    </table>
...
<?php /**PATH C:\Users\Marc Ian C. Young\laravel\fceerguildweb\resources\views/livewire/profile/credentials/subsections/professional_credentials/archive-modal.blade.php ENDPATH**/ ?>