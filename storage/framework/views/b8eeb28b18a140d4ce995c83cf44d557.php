...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::icon.index','data' => ['name' => 'list','class' => 'w-5 h-5 text-gray-700 dark:text-gray-300']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => 'list','class' => 'w-5 h-5 text-gray-700 dark:text-gray-300']); ?>
...
<?php endif; ?>
	...
	<?php if (! $__env->hasRenderedOnce('7fd483d8-9475-4da1-b193-b8b540f50270')): $__env->markAsRenderedOnce('7fd483d8-9475-4da1-b193-b8b540f50270'); ?>
			...
			<table class="min-w-full divide-y">
				...
				<tbody class="divide-y">
					<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						...
						?>
						<tr class="group <?php echo e($isSelected ? 'bg-gray-50 dark:bg-zinc-700 selected' : 'bg-white dark:bg-zinc-800'); ?>"
		...
		<div class="grid grid-cols-1 <?php echo e($records->count() > 1 ? 'md:grid-cols-2' : 'md:grid-cols-1'); ?> gap-4" x-data="{ selectedLocal: <?php if ((object) ('selected') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('selected'->value()); ?>')<?php echo e('selected'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('selected'); ?>')<?php endif; ?> }">
			<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				...
				<div wire:key="card-row-<?php echo e($rowKeyStr); ?>" class="bg-white dark:bg-zinc-800 border border-gray-200 dark:border-zinc-700 rounded p-4 relative">
					<div class="space-y-1">
						<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $fields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<div class="text-sm text-gray-600 dark:text-gray-300"><?php echo e($field['label']); ?>: <?php echo e($item->{$field['key']} ?? '—'); ?></div>
						<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
					</div>
				</div>
			<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1834710931-0', 'subject-teachers-form-'.$user->id);
...
$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1834710931-1', 'subject-teachers-details-'.$user->id);
...
[$__name, $__params] = $__split('profile.fceer.subsections.subject-teachers.subject-teachers-archive', []);

$key = 'subject-teachers-archive-'.$user->id;

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1834710931-2', 'subject-teachers-archive-'.$user->id);
...
[$__name, $__params] = $__split('profile.fceer.subsections.subject-teachers.subject-teachers-delete-modal', []);

$key = 'subject-teachers-delete-'.$user->id;

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1834710931-3', 'subject-teachers-delete-'.$user->id);
...
[$__name, $__params] = $__split('profile.fceer.subsections.subject-teachers.subject-teachers-restore-modal', []);

$key = 'subject-teachers-restore-'.$user->id;

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1834710931-4', 'subject-teachers-restore-'.$user->id);
...
[$__name, $__params] = $__split('profile.fceer.subsections.subject-teachers.subject-teachers-force-delete-modal', []);

$key = 'subject-teachers-force-delete-'.$user->id;

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1834710931-5', 'subject-teachers-force-delete-'.$user->id);
...
<?php /**PATH C:\Users\Marc Ian C. Young\laravel\fceerguildweb\resources\views/livewire/profile/fceer/subsections/subject-teachers/index.blade.php ENDPATH**/ ?>