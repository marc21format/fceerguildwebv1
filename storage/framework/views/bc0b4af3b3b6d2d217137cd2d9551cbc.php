...
<?php endif; ?>
    ...
    <?php if (! $__env->hasRenderedOnce('6318c63a-d575-4736-b12f-ea04b1c21561')): $__env->markAsRenderedOnce('6318c63a-d575-4736-b12f-ea04b1c21561'); ?>
                ...
                <table class="min-w-full divide-y">
                    ...
                    <tbody class="divide-y">
                        <tr class="bg-white dark:bg-zinc-800">
                            ...
                            <td class="px-4 py-2 text-sm text-gray-500 dark:text-gray-400"><?php echo e(optional($profile)->first_name ?? '—'); ?></td>
                        </tr>
                        <tr class="bg-white dark:bg-zinc-800">
                            <td class="px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300">Middle Name</td>
                            <td class="px-4 py-2 text-sm text-gray-500 dark:text-gray-400"><?php echo e(optional($profile)->middle_name ?? '—'); ?></td>
                        </tr>
                        <tr class="bg-white dark:bg-zinc-800">
                            <td class="px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300">Suffix Name</td>
                            <td class="px-4 py-2 text-sm text-gray-500 dark:text-gray-400"><?php echo e(optional($profile)->suffix_name ?? '—'); ?></td>
                        </tr>
                        <tr class="bg-white dark:bg-zinc-800">
                            <td class="px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300">Lived Name</td>
                            <td class="px-4 py-2 text-sm text-gray-500 dark:text-gray-400"><?php echo e(optional($profile)->lived_name ?? '—'); ?></td>
                        </tr>
                        <tr class="bg-white dark:bg-zinc-800">
                            <td class="px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300">Sex</td>
                            <td class="px-4 py-2 text-sm text-gray-500 dark:text-gray-400">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(optional($profile)->sex): ?>
                                    <?php if(optional($profile)->sex === 'M'): ?> Male
                                    <?php elseif(optional($profile)->sex === 'F'): ?> Female
                                    <?php else: ?> Other
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <?php else: ?>
                                    —
                        ...
                        <tr class="bg-white dark:bg-zinc-800">
                            ...
                            <td class="px-4 py-2 text-sm text-gray-500 dark:text-gray-400"><?php echo e(optional($profile)->birthday ? optional($profile)->birthday->format('F d, Y') : '—'); ?></td>
                        </tr>
                    </tbody>
                </table>
            </div>
        <?php else: ?>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="bg-white dark:bg-zinc-800 border border-gray-200 dark:border-zinc-700 rounded p-4">
                    ...
                    <dd class="profile-details-value mt-1"><?php echo e(optional($profile)->first_name ?? '—'); ?></dd>
                </div>

                <div class="bg-white dark:bg-zinc-800 border border-gray-200 dark:border-zinc-700 rounded p-4">
                    <dt class="profile-details-label">Middle Name</dt>
                    <dd class="profile-details-value mt-1"><?php echo e(optional($profile)->middle_name ?? '—'); ?></dd>
                </div>

                <div class="bg-white dark:bg-zinc-800 border border-gray-200 dark:border-zinc-700 rounded p-4">
                    <dt class="profile-details-label">Suffix Name</dt>
                    <dd class="profile-details-value mt-1"><?php echo e(optional($profile)->suffix_name ?? '—'); ?></dd>
                </div>

                <div class="bg-white dark:bg-zinc-800 border border-gray-200 dark:border-zinc-700 rounded p-4">
                    <dt class="profile-details-label">Lived Name</dt>
                    <dd class="profile-details-value mt-1"><?php echo e(optional($profile)->lived_name ?? '—'); ?></dd>
                </div>
                ...
                <div class="bg-white dark:bg-zinc-800 border border-gray-200 dark:border-zinc-700 rounded p-4">
                    ...
                    <dd class="profile-details-value mt-1"><?php echo e(optional($profile)->birthday ? optional($profile)->birthday->format('F d, Y') : '—'); ?></dd>
                </div>
            </div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
[$__name, $__params] = $__split('profile.personal.subsections.identification.identification-form-modal', ['instanceKey' => 'App\\Models\\UserProfile']);

$key = 'identification-form-'.$user->id;

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-3314372242-0', 'identification-form-'.$user->id);
...
[$__name, $__params] = $__split('profile.personal.subsections.identification.identification-confirm-modal', []);

$key = 'identification-confirm-'.$user->id;

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-3314372242-1', 'identification-confirm-'.$user->id);
...
<?php /**PATH C:\Users\Marc Ian C. Young\laravel\fceerguildweb\resources\views/livewire/profile/personal/subsections/identification/index.blade.php ENDPATH**/ ?>