...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::modal.trigger','data' => ['name' => 'classroom-responsibilities-archive']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => 'classroom-responsibilities-archive']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::modal.index','data' => ['name' => 'classroom-responsibilities-archive','flyout' => true,'position' => 'bottom','class' => 'md:w-lg','wire:model' => 'open','@close' => '$set(\'open\', false)','role' => 'dialog','ariaModal' => 'true']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'classroom-responsibilities-archive','flyout' => true,'position' => 'bottom','class' => 'md:w-lg','wire:model' => 'open','@close' => '$set(\'open\', false)','role' => 'dialog','aria-modal' => 'true']); ?>
                <div class="space-y-4">
                                    ...
                                    <tbody class="divide-y">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            ...
                                            <tr class="group bg-white dark:bg-zinc-800" wire:key="archive-row-<?php echo e($rowKeyStr); ?>" @click.prevent="if ($event.target.closest('button, input, a')) return; $wire.toggleRow('<?php echo e($rowKeyStr); ?>')" x-on:mouseenter="$store.rowHover.hovered = '<?php echo e($rowKeyStr); ?>'" x-on:mouseleave="$store.rowHover.hovered = null">
                                                ...
                                                <td class="px-4 py-2 text-sm text-gray-700 dark:text-gray-200"><?php echo e(optional($item->classroom)->name ?? '—'); ?></td>
                                                <td class="px-4 py-2 text-sm text-gray-700 dark:text-gray-200"><?php echo e(optional($item->classroomPosition)->name ?? '—'); ?></td>
...
<?php /**PATH C:\Users\Marc Ian C. Young\laravel\fceerguildweb\resources\views/livewire/profile/fceer/subsections/classroom_responsibilities/archive-modal.blade.php ENDPATH**/ ?>