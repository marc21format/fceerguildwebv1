<div x-data='{
    ...
    select(id) { this.selected = id; $wire.set("state.<?php echo e($name); ?>", id); this.open = false; }
...
<?php /**PATH C:\Users\Marc Ian C. Young\laravel\fceerguildweb\resources\views/livewire/components/styled-select.blade.php ENDPATH**/ ?>