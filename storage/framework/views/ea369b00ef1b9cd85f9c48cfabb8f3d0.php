...
<?php elseif ($as === 'a' || $href): ?>
    ...
    <a href="<?php echo e($href); ?>" <?php echo e($attributes->merge(['data-current' => $current, 'wire:current.ignore' => $current !== null])); ?>>
        <?php echo e($slot); ?>

    </a>
<?php else: ?>
    <button <?php echo e($attributes->merge(['type' => $type, 'data-current' => $current, 'wire:current.ignore' => $current !== null])); ?>>
        <?php echo e($slot); ?>

    </button>
<?php endif; ?>
<?php /**PATH C:\Users\Marc Ian C. Young\laravel\fceerguildweb\vendor\livewire\flux\src/../stubs/resources/views/flux/button-or-link.blade.php ENDPATH**/ ?>