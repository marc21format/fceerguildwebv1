...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::modal.index','data' => ['name' => 'professional-credential-details-modal','flyout' => true,'class' => 'w-11/12 max-w-2xl','wire:model' => 'open','@close' => '$set(\'open\', false)']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => 'professional-credential-details-modal','flyout' => true,'class' => 'w-11/12 max-w-2xl','wire:model' => 'open','@close' => '$set(\'open\', false)']); ?>
                <div class="space-y-6">
                    <div>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['size' => 'lg']); ?>Professional Credential Details <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $fields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(! $isEmpty): ?>
                                <div class="grid grid-cols-3 gap-4 items-start">
                                    <div class="text-sm font-medium text-gray-600 dark:text-gray-300"><?php echo e($f['label'] ?? ucfirst($key)); ?></div>
                                    <div class="col-span-2 text-sm text-gray-800 dark:text-gray-200"><?php echo e($val); ?></div>
                                </div>
...
<?php /**PATH C:\Users\Marc Ian C. Young\laravel\fceerguildweb\resources\views/livewire/profile/credentials/subsections/professional_credentials/details-modal.blade.php ENDPATH**/ ?>