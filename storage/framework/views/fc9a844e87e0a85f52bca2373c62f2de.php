...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::modal.index','data' => ['name' => 'identification-form','flyout' => true,'class' => 'w-11/12 max-w-2xl','wire:model' => 'isOpen','@close' => '$set(\'isOpen\', false)']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => 'identification-form','flyout' => true,'class' => 'w-11/12 max-w-2xl','wire:model' => 'isOpen','@close' => '$set(\'isOpen\', false)']); ?>
                <div class="space-y-6">
                    <div>
                    ...
                    <div class="grid grid-cols-1 gap-4">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $fields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($fieldKey && !is_array($fieldKey)): ?>
                                <div>
                                    <label class="block text-base font-medium text-gray-700 dark:text-gray-100"><?php echo e($fieldLabel); ?></label>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($fieldType === 'select'): ?>
                                        <?php
                                            $sel = $state[$fieldKey] ?? '';
                                        ?>
                                        <?php echo $__env->make('livewire.components.styled-select', ['name' => $fieldKey, 'options' => $opts, 'selected' => $sel, 'placeholder' => 'Select'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                    <?php elseif($fieldType === 'date'): ?>
                                        <input wire:model.defer="state.<?php echo e($fieldKey); ?>" type="date" class="mt-1 block w-full rounded-md border border-gray-200 dark:border-zinc-600 bg-gray-50 dark:bg-zinc-700 text-gray-900 dark:text-gray-100 px-3 py-3 text-sm" />
                                    <?php else: ?>
                                        <input wire:model.defer="state.<?php echo e($fieldKey); ?>" type="<?php echo e($fieldType); ?>" class="mt-1 block w-full rounded-md border border-gray-200 dark:border-zinc-600 bg-gray-50 dark:bg-zinc-700 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-zinc-500 px-3 py-3 text-sm" placeholder="<?php echo e($fieldPlaceholder); ?>" />
...
<?php /**PATH C:\Users\Marc Ian C. Young\laravel\fceerguildweb\resources\views/livewire/profile/personal/subsections/identification/form-modal.blade.php ENDPATH**/ ?>